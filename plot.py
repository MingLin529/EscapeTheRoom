...
class StartingPlot(Story):
    def __init__(self):
        ...
        "thing. As a senior YouTuber, you have seen animation since "
        "childhood and you with rich imagination have decided to face this "
        "problem alone. After some thoughts, you decide:"
...
class SearchForWiFi(Story):
    def __init__(self):
        self.plots = "It is indeed you that you decide to pull out your "
        "phone first and search for WiFi here. Unfortunately, there's no "
        "WiFi and not even a sign of signals here. Your phone has only 2% of "
        "battery left, also there are 83 missed calls. You open the call "
        "log. Most of these 83 missed calls are from your mother. The last "
        "call was at 8:07 last night. In other words, after 8:07 last night, "
        "you entered the no-signal zone. And the person kidnapped you didn't "
        "confiscate your phone. As a very important communication tool, "
        "mobile phones need to be handled properly. So you decide:"


class TurnOnLowBatteryMode(Story):
    def __init__(self):
        self.plots = "It is indeed you! You have decided to turn on your "
        "phone in energy-saving mode, so that if your phone enters the "
        "signal area, you can receive calls as soon as possible. You put "
...
class Transition1(Story):
    def __init__(self):
        ...
        "imagined a lot of scenes that will only appear in the game. If it "
        "is the same as in the game, then this is a magic circle. Dense and "
